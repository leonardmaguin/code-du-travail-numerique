...
const getProgressionLabel = (filters, key) =>
  getTagLabel(key) +
  ": " +
    ...
    render={({ addFilter, removeFilter, resetFilters, filters }) => (
      <NextQuestion
        ...
        render={({ question, results }) => {
          //console.log({ filters, question, results });
          const answers =
            question &&
          ...
          if (answers) {
            ...
            //console.log({ answers, data, question, results, sumDocsByAnswer });
          ...
          return (
            <div>
              <Progression
                ...
                filters={filters}
                getLabel={key => getProgressionLabel(filters, key)}
              />
              {question && (
                <Question
