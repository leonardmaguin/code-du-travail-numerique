...
def explore_article(root):
	...
	#print(root[0][1][0][2].text)
	#etat = root.find('META/META_COMMUN/')
	#print(etat)
...
"""
	print(content)
	print("HEEEEEEEEEEERRREEEEE")
	html_content = ET.tostring(content, encoding="unicode")
	print(html_content)

	print("PPOOOOOOOOOOOOOOOOOOW")
	htmler_content = html_content[(html_content.find("<CONTENU>")+10):(html_content.find("</CONTENU>")-1)]
	print(htmler_content)
	#### b'<CONTENU>\n<p align="left">\n<br />En applicati [...] les hommes.</p>\n</CONTENU>\n'
	print("PPOOOOOOOOOOOOOOOOOOW")
"""