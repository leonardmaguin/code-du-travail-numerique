...
```shell
$ docker exec -ti code-du-travail-numerique_python_1 pipenv run python search/indexing/create_indexes.py
```

## Pour lancer un shell Docker

```shell
$ docker exec -ti code-du-travail-numerique_python_1 /bin/sh
